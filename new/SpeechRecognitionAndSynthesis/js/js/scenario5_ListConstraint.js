...
(function () {
    ...
    function initializeRecognizer(language) {
	    ...
	    recognizer.constraints.append(
	        Windows.Media.SpeechRecognition.SpeechRecognitionListConstraint([
		        resourceMap.getValue('Sentence1', context).valueAsString,
		        resourceMap.getValue('Sentence2', context).valueAsString,
		        resourceMap.getValue('Sentence3', context).valueAsString,
		        resourceMap.getValue('Sentence4', context).valueAsString,
		        resourceMap.getValue('Sentence5', context).valueAsString,
	], "Sentences"));
